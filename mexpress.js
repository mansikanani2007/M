...
mg.connect("mongodb://localhost:27017/mydb").then(()=>console.log("connection successfully")).catch((e)=>console.log("connection failed ",e));
...
const sc=mg.Schema({
    ...
    app.get("/signup",async(req,res)=>{
        try{
            ...
            res.send("sorry! cannot create user");
        }
    })
